...
if [ "$1" = "test" ]; then
    ...
    assert 7 "{ return 4 + 3; }"
    assert 5 "{ return 8 - 3; }"
    assert 5 "{ return 4 + 3 - 2; }"
    assert 8 "{ return 4 + 4 - 2 + 2; }"
    assert 12 "{ return 4 * 3; }"
    assert 2 "{ return 14 - 4 * 3; }"
    assert 4 "{ return 12 / 3; }"
    assert 2 "{ return 12 % 5; }"
    assert 5 "{ return 12 % 5 + 3; }"
    assert 10 "{ return 12 - 12 % 5; }"
    assert 30 "{ return (10 + 5) * 2; }"
    assert 4 "{ return 20 / (10 - 5); }"
    assert 5 "{ return (5 + 5) / (4 - 2); }"
    assert 10 "{ return +5 + +5; }"
    assert 20 "{ return --20; }"
    assert 10 "{ return ---20 + +30; }"
    assert 1 "{ return 1000000 == 1000000; }"
    assert 1 "{ return 1000000 != 1000001; }"
    assert 0 "{ return 5 > 6; }"
    assert 0 "{ return 6 < 5; }"
    assert 0 "{ return 5 != (3 + 2); }"
    assert 1 "{ return 10 < 5 * 3; }"
    assert 1 "{ return 0x0f == 15; }"
    assert 1 "{ return 0x0f - 011 == 6; }"
    assert 1 "{ return 0b1001 == 8 + 1; }"
    assert 5 "{ 4;return 5;6; }"
    assert 5 "{ ;;45;;6; return 10 - 5; }"
    assert 6 "{ return ~~6; }"
    assert 0 "{ return !!!1; }"
    assert 1 "{ return !(5 == 4); }"
    assert 44 "{ return 3245 & 44; }"
    assert 33 "{ return 33 | 1; }"
    assert 46 "{ return 33 ^ 15; }"
    assert 20 "{ return 5 << 2; }"
    assert 4 "{ return (20 >> 2) - 1; }"
    assert 0 "{ return 0 && 1; }"
    assert 1 "{ return (20 > 5) && 1; }"
    assert 1 "{ return 0 || 1; }"
    assert 0 "{ return 0 || 0; }"

    assert 15 "{ int a; a = 10; return a + 5; }"
    ...
    assert 14 "{ int a, b; a = 10, b = 4; return a + b; }"
    assert 2 "{ int a, b; a = 10, b = 4; return a - (b * 2); }"
    assert 10 "{ int a, b; a = b = 5; return a + b; }"
    assert 27 "{ int a, b, c; a = b = c = 5; c = 2; return a * b + c; }"
