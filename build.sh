...
if [ "$1" = "test" ]; then
    ...
    assert 2 "{ int a; a = 4; if (a > 4) { return 1; } else if (a == 4) { return 2; } else return 3; }"
    assert 16 "{ int a;  a = 4; if (a == 4) { return 4 \* 4; } else return 4 + (8 - 4); }"
    assert 5 "{ int i; i = 0; while (i < 5) i += 1; return i; }"
    assert 5 "{ int i; i = 0; do i += 1; while (i < 5); return i; }"
    assert 5 "{ int i; for (i = 0; i < 10; i += 1) { if (i == 5) return i; } }"
    assert 10 "{ int i; i = 0; for (; i < 10; i += 1); return i; }"
    assert 8 "{ int i; i = 0; for (;i < 8;) i += 1; return i; }"
    assert 4 "{ int i; i = 0; for (;;) { i += 1; if (i == 4) return i; } return 45; }"
    assert 2 "{ int i; i = 7; while (i > 2) { i = i - 1; } return i; }"
